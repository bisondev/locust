...
class RequestStats(object):
    ...
    def log_request(self, method, name, response_time, content_length, cache_hit):
...
def on_request_success(request_type, name, response_time, response_length, cache_hit):
    global_stats.log_request(request_type, name, response_time, response_length, cache_hit)
